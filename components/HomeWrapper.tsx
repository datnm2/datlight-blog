...
export default function HomeWrapper({ allPosts }: HomeWrapperProps) {
  const { locale, t } = useLanguage()

  // Filter posts by current language
  const posts = filterPostsByLanguage(allPosts as Blog[], locale) as CoreContent<Blog>[]
    ...
    <>
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <ul className="divide-y divide-gray-200 dark:divide-gray-700">
          {!posts.length && t('blog.noPostsFound')}
                    ...
                    <div className="space-y-5 xl:col-span-3">
                      ...
                      <div className="text-base leading-6 font-medium">
                        <Link
                          ...
                          aria-label={`${t('home.readMore')}: "${title}"`}
                        >
